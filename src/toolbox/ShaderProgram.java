...
public class ShaderProgram 
{
	...
	public ShaderProgram(MyFile vertexFile, MyFile fragmentFile, String... inVariables) 
	{
		...
		/*
		int vertexShaderID = shaders.ShaderProgram.LoadShader(vertexFile.getName(), GL20.GL_VERTEX_SHADER);
		int fragmentShaderID = shaders.ShaderProgram.LoadShader(fragmentFile.getName(), GL20.GL_FRAGMENT_SHADER);
		*/
