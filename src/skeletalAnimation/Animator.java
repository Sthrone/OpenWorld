...
public class Animator 
{
	...
	public void Update() 
	{
		if (pause || currentAnimation == null) 
		{
			return;
		}
	...
	private Map<String, Matrix4f> CalculateCurrentAnimationPose() 
	{
		...
		float progression = CalculateProgression(frames[0], frames[1]); // Broj izmedju 0 i 1, koji pokazuje koliko je izmedju dva keyframe-a
